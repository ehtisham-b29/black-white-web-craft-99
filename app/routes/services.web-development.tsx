...
export const meta: MetaFunction = () => {
  return [
    { title: "Web Development Services | Realz Solutions" },
    { name: "description", content: "Create stunning, high-performance websites that captivate your audience and drive business growth. Expert web development from simple landing pages to complex web applications." },
  ];
};
