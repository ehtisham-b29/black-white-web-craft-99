...
export const meta: MetaFunction = () => {
  return [
    { title: "Terms of Service | Realz Solutions" },
    { name: "description", content: "Clear, transparent terms that protect both our clients and our business. Read our terms of service for using Realz Solutions' website and services." },
  ];
};
