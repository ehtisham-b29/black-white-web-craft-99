...
export const meta: MetaFunction = () => {
  return [
    { title: "Security & Maintenance | Realz Solutions" },
    { name: "description", content: "Protect your digital assets and ensure optimal performance with comprehensive security audits and ongoing maintenance services. Keep your applications secure, updated, and running smoothly 24/7." },
  ];
};
