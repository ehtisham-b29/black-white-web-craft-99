...
export const meta: MetaFunction = () => {
  return [
    { title: "Database Solutions | Realz Solutions" },
    { name: "description", content: "Unlock the full potential of your data with robust, scalable database solutions. Expert database design, optimization, and maintenance services." },
  ];
};
