...
export const meta: MetaFunction = () => {
  return [
    { title: "Mobile App Development | Realz Solutions" },
    { name: "description", content: "Transform your business with powerful mobile applications that engage users and drive growth. Native and cross-platform apps that deliver exceptional experiences on iOS and Android." },
  ];
};
