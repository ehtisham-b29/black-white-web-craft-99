...
export const meta: MetaFunction = () => {
  return [
    { title: "Privacy Policy | Realz Solutions" },
    { name: "description", content: "Your privacy is important to us. Learn how we collect, use, and protect your information when you use our services." },
  ];
};
