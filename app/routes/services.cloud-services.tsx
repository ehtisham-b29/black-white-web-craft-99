...
export const meta: MetaFunction = () => {
  return [
    { title: "Cloud Services | Realz Solutions" },
    { name: "description", content: "Migrate to the cloud and unlock unlimited scalability, enhanced security, and reduced costs. Expert cloud services to accelerate growth and innovation." },
  ];
};
