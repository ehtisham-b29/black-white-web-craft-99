...
export const meta: MetaFunction = () => {
  return [
    { title: "Cookie Policy | Realz Solutions" },
    { name: "description", content: "Understanding how we use cookies to enhance your experience on our website. Learn about cookie types, usage, and how to manage them." },
  ];
};
