...
export const meta: MetaFunction = () => {
  return [
    { title: "Custom Software Development | Realz Solutions" },
    { name: "description", content: "Transform your unique business challenges into competitive advantages with our bespoke software solutions. Powerful, scalable applications designed specifically for your organization's needs." },
  ];
};
